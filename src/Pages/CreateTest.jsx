  ...
  return (
    <div className="p-8 bg-sky-100 min-h-screen">
     ...
     <button className="px-4 py-1 text-center bg-sky-600 hover:bg-sky-700 text-white rounded"> <Link to="/adminpage" className="">Back</Link></button>
        ...
        <h2 className="bg-sky-800 text-white rounded py-2 px-6 w-fit mx-auto text-lg font-semibold">
          Test Details
        </h2>
      ...
      <div className="space-y-8 ml-56 ">
        ...
        <input type="text" placeholder="Test Name" name="Name" className="block w-[calc(100%-14rem)] bg-white p-2 rounded" />
        <textarea placeholder="Test Desc." className="block w-[calc(100%-14rem)] bg-white p-2 rounded h-24 resize-none"></textarea>
        <div className="flex flex-wrap gap-4">
          <input type="text" placeholder="Time and Date" className="block w-[calc(50%-7rem)] bg-white p-2 rounded" />
          <input type="text" placeholder="Duration" className="block w-[calc(50%-8rem)] bg-white p-2 rounded" />
        </div>
      ...
      <div className="mt-8 mx-56">
        {questions.map((q, qIndex) => (
          <div key={qIndex} className="mb-6 p-4 bg-white rounded shadow-md">
  ...
  />
            ...
            <div className="relative">
              <input
                ...
                className="block w-full bg-gray-100 p-2 rounded pr-10" 
              />
      ...
      <div className="text-center mt-8">
       <Link to="/"> <button className="bg-sky-500 cursor-pointer hover:bg-sky-700 text-white py-2 px-6 rounded">Create Test</button>
       </Link>
      </div>
    </div>
  );
